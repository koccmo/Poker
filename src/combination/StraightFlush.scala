...
case object StraightFlush extends Combination {
  ...
  val straightFlush: Map[String, Int] = Map("A2345" -> 1, "23456" -> 2, "34567" -> 3, "45678" -> 4, "56789" -> 5, "6789T" -> 6,
    "789TJ" -> 7, "89TJQ" -> 8, "9TJQK" -> 9, "TJQKA" -> 10)

  val hSuit: Map[String, Int] = Map("Ah2h3h4h5h" -> 901, "2h3h4h5h6h" -> 902, "3h4h5h6h7h" -> 903, "4h5h6h7h8h" -> 904, "5h6h7h8h9h" -> 905,
    "6h7h8h9hTh" -> 906, "7h8h9hThJh" -> 907, "8h9hThJhQh" -> 908, "9hThJhQhKh" -> 909, "ThJhQhKhAh" -> 910)

  val dSuit: Map[String, Int] = Map("Ad2d3d4d5d" -> 901, "2d3d4d5d6d" -> 902, "3d4d5d6d7d" -> 903, "4d5d6d7d8d" -> 904, "5d6d7d8d9d" -> 905,
    "6d7d8d9dTd" -> 906, "7d8d9dTdJd" -> 907, "8d9dTdJdQd" -> 908, "9dTdJdQdKd" -> 909, "TdJdQdKdAd" -> 910)

  val cSuit: Map[String, Int] = Map("Ac2c3c4c5c" -> 901, "2c3c4c5c6c" -> 902, "3c4c5c6c7c" -> 903, "4c5c6c7c8c" -> 904, "5c6c7c8c9c" -> 905,
    "6c7c8c9cTc" -> 906, "7c8c9cTcJc" -> 907, "8c9cTcJcQc" -> 908, "9cTcJcQcKc" -> 909, "TcJcQcKcAc" -> 910)

  val sSuit: Map[String, Int] = Map("As2s3s4s5s" -> 901, "2s3s4s5s6s" -> 902, "3s4s5s6s7s" -> 903, "4s5s6s7s8s" -> 904, "5s6s7s8s9s" -> 905,
  ...
  def checkCombByRank(listOfCards: List[Card]): Boolean = {
...
//    combination.exists(x => (listCardRank.sorted intersect x).size == similarCardQuantity)
  ...
  def myComb(listOfCards: List[Card]): List[String] = {
    @tailrec
